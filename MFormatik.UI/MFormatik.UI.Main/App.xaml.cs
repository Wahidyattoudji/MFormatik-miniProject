...
using MFormatik.UI.Common;
using MFormatik.UI.Main.Properties;
using MFormatik.UI.Main.ViewModels;
using MFormatik.UI.Main.Views;
using MFormatik.UI.Modules.ViewModels;
using MFormatik.UI.Modules.Views;
using System.ComponentModel;
using System.Windows;
using AppModules = MFormatik.UI.Common.Modules;

namespace MFormatik.UI.Main
{
